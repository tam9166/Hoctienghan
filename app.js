...
MAIN_VIEWS.push('education-platform', 'teacher-dashboard', 'organization-center', 'education-assignments', 'education-feedback', 'course-builder', 'organization-analytics', 'education-content');
...
const AccessControlService = {
  role() {
    ...
    return ['student', 'teacher', 'reviewer', 'content_editor', 'admin'].includes(role) ? role : 'student';
  },
