...
function syncShell() {
  ...
  document.querySelectorAll('.nav-item').forEach((button) => {
    ...
    const activeView = state.currentView === 'daily-session' ? 'home'
      : ['conversation-simulator','natural-korean','reading-lab','reading-session','word-network','collocation-trainer','dictation-master'].includes(state.currentView) ? 'lessons'
