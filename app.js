...
const STORAGE_KEYS = Object.freeze({
  ...
  speaking: 'klearn_speaking', aiContentDrafts: 'klearn_ai_content_drafts', aiAgents: 'klearn_ai_agents', aiLanguageOs: 'klearn_ai_language_os', globalEducationMarketplace: 'klearn_global_education_marketplace',
  writing: 'klearn_writing', listeningSessions: 'klearn_listening_sessions', writingAttempts: 'klearn_writing_attempts', speakingSessions: 'klearn_speaking_sessions', conversationHistory: 'klearn_conversation_history', readingExpansion: 'klearn_reading_expansion', languageMastery: 'klearn_language_mastery', immersionMotivation: 'klearn_immersion_motivation', immersiveWorld: 'klearn_immersive_world', immersiveKoreanWorld: 'klearn_immersive_korean_world', ecosystemExpansion: 'klearn_ecosystem_expansion', careerLearning: 'klearn_career_learning', realGoalPlans: 'klearn_real_goal_plans', learningJournal: 'klearn_learning_journal', teacherFeedback: 'klearn_teacher_feedback', manualReviewQueue: 'klearn_manual_review_queue', teacherWorkspace: 'klearn_teacher_workspace', educationPlatform: 'klearn_education_platform', educationEcosystem: 'klearn_education_ecosystem', communityProgress: 'klearn_community_progress', enterprisePlatform: 'klearn_enterprise_platform', monetization: 'klearn_monetization', subscriptionEntitlementCache: 'klearn_subscription_entitlement_cache', productGrowth: 'klearn_product_growth', productDemo: 'klearn_product_demo', futureLanguage: 'klearn_future_language_platform', productUx: 'klearn_product_ux', retention: 'klearn_retention', research: 'klearn_user_research', analyticsReports: 'klearn_analytics_reports', learningOutcomes: 'klearn_learning_outcomes', premiumLearning: 'klearn_premium_learning', examAttempts: 'klearn_exam_attempts', notes: 'klearn_notes', bookmarks: 'klearn_bookmarks', contentFeedback: 'klearn_content_feedback', competitiveContentProgress: 'klearn_competitive_content_progress', resourceProgress: 'klearn_resource_progress', highlights: 'klearn_highlights', supportRequests: 'klearn_support_requests', dictionaryFavorites: 'klearn_dictionary_favorites', savedSentences: 'klearn_saved_sentences', translationHistory: 'klearn_translation_history', recentSearches: 'klearn_recent_searches', handwriting: 'klearn_handwriting', learnerProfile: 'klearn_learner_profile', languageProfiles: 'klearn_language_profiles', languageLearningState: 'klearn_language_learning_state', longTermLearningMemory: 'klearn_long_term_learning_memory', syncMeta: 'klearn_sync_meta', dailyPlan: 'klearn_daily_plan', dailyExperience: 'klearn_daily_experience', notifications: 'klearn_notifications', errors: 'klearn_errors', weeklyReports: 'klearn_weekly_reports', dailyMissions: 'klearn_daily_missions', learningGoals: 'klearn_learning_goals', learningIntelligence: 'klearn_learning_intelligence', adaptiveRoadmaps: 'klearn_adaptive_roadmaps', aiMemory: 'klearn_ai_memory', aiInfrastructure: 'klearn_ai_infrastructure', knowledgeProgress: 'klearn_knowledge_progress', grammarNotebook: 'klearn_grammar_notebook', typingProgress: 'klearn_typing_progress', repairPaths: 'klearn_repair_paths', focusSessions: 'klearn_focus_sessions', checkpoints: 'klearn_checkpoints', offlinePacks: 'klearn_offline_packs', shadowingProgress: 'klearn_shadowing_progress', milestones: 'klearn_milestones', achievements: 'klearn_achievements', contentDrafts: 'klearn_content_drafts', contentCatalogCache: 'klearn_content_catalog_cache', vocabularyCollections: 'klearn_vocabulary_collections', vocabularyOrganization: 'klearn_vocabulary_organization', sentenceBuilderProgress: 'klearn_sentence_builder_progress', realLifeProgress: 'klearn_real_life_progress', productionTelemetry: 'klearn_production_telemetry', backgroundSyncQueue: 'klearn_background_sync_queue', learningBackups: 'klearn_learning_backups', recoveryCheckpoint: 'klearn_recovery_checkpoint', privacyPreferences: 'klearn_privacy_preferences', deviceRegistry: 'klearn_device_registry', securityAudit: 'klearn_security_audit', mobileExperience: 'klearn_mobile_experience', voiceLearning: 'klearn_voice_learning', migrationBackup: 'klearn_migration_backup_v8'
});
...
MAIN_VIEWS.push('learning-path', 'learning-progress', 'beginner-vocabulary-review', 'beginner-vocabulary-session');
...
MAIN_VIEWS.push('language-mastery', 'subtitle-learning', 'vocabulary-image-memory', 'grammar-mastery');
MAIN_VIEWS.push('immersion-journey', 'survival-kit', 'media-learning', 'slang-dictionary', 'daily-korean-feed', 'monthly-challenge', 'achievement-room', 'personal-portfolio');
MAIN_VIEWS.push('topik-strategy-center', 'real-goal-planner', 'learning-journal', 'teacher-review', 'manual-review-queue', 'teacher-workspace', 'community-hub', 'personal-report', 'daily-session');
MAIN_VIEWS.push('education-platform', 'teacher-dashboard', 'organization-center', 'education-assignments', 'education-feedback', 'course-builder', 'organization-analytics', 'education-content', 'education-ecosystem', 'assessment-center', 'creator-workflow', 'school-report', 'education-certificates');
MAIN_VIEWS.push('global-language-onboarding', 'global-writing-system', 'global-content-packs', 'global-language-search', 'global-adaptive-plan');
MAIN_VIEWS.push('immersive-world', 'virtual-korean-city', 'immersive-session', 'roleplay-game', 'debate-studio', 'career-korean', 'university-life', 'travel-simulator', 'voice-world', 'speaking-journey', 'learning-avatar-research');
...
MAIN_VIEWS.push('enterprise-platform', 'subscription-center', 'premium-features', 'school-management', 'center-dashboard', 'course-marketplace', 'certification-center', 'partner-api', 'admin-analytics', 'language-platform');
...
MAIN_VIEWS.push('vietnamese-korean-core');
...
MAIN_VIEWS.push('premium-center', 'subscription-admin');
MAIN_VIEWS.push('future-language-platform', 'cross-language-lab', 'language-brain', 'future-integrations', 'global-course-marketplace');
MAIN_VIEWS.push('global-language-platform', 'global-language-profiles', 'global-exam-framework', 'global-language-comparison', 'global-expansion');
MAIN_VIEWS.push('ai-language-os');
...
const SRSStateService = {
  ...
  isDue(card = {}, at = Date.now()) {
    ...
    return [SRS_STATES.LEARNING, SRS_STATES.REVIEW, SRS_STATES.MASTERED].includes(status) && Number.isFinite(dueAt) && dueAt <= Number(at);
  },
...
const AccessControlService = {
  role() {
    ...
    return ['student', 'teacher', 'reviewer', 'content_editor', 'content_creator', 'center_admin', 'admin', 'super_admin'].includes(role) ? role : 'student';
  },
  canReview() { return ['teacher', 'reviewer', 'content_editor', 'admin'].includes(this.role()); },
  canManageReviews() { return ['reviewer', 'content_editor', 'admin'].includes(this.role()); },
...
const USER_SYNC_KEYS = Object.freeze([
  ...
  STORAGE_KEYS.translationHistory, STORAGE_KEYS.recentSearches, STORAGE_KEYS.handwriting, STORAGE_KEYS.learnerProfile, STORAGE_KEYS.languageProfiles, STORAGE_KEYS.languageLearningState, STORAGE_KEYS.longTermLearningMemory,
  STORAGE_KEYS.dailyPlan, STORAGE_KEYS.dailyExperience, STORAGE_KEYS.languageMastery, STORAGE_KEYS.immersionMotivation, STORAGE_KEYS.immersiveKoreanWorld, STORAGE_KEYS.notifications, STORAGE_KEYS.errors, STORAGE_KEYS.weeklyReports, STORAGE_KEYS.dailyMissions, STORAGE_KEYS.learningGoals, STORAGE_KEYS.learningIntelligence, STORAGE_KEYS.adaptiveRoadmaps, STORAGE_KEYS.aiMemory, STORAGE_KEYS.aiInfrastructure, STORAGE_KEYS.aiAgents, STORAGE_KEYS.aiLanguageOs, STORAGE_KEYS.knowledgeProgress, STORAGE_KEYS.listeningSessions, STORAGE_KEYS.writingAttempts, STORAGE_KEYS.speakingSessions, STORAGE_KEYS.examAttempts, STORAGE_KEYS.notes, STORAGE_KEYS.bookmarks, STORAGE_KEYS.contentFeedback, STORAGE_KEYS.competitiveContentProgress, STORAGE_KEYS.resourceProgress, STORAGE_KEYS.highlights, STORAGE_KEYS.grammarNotebook, STORAGE_KEYS.typingProgress, STORAGE_KEYS.repairPaths, STORAGE_KEYS.focusSessions, STORAGE_KEYS.checkpoints, STORAGE_KEYS.shadowingProgress, STORAGE_KEYS.milestones, STORAGE_KEYS.achievements, STORAGE_KEYS.vocabularyCollections, STORAGE_KEYS.vocabularyOrganization, STORAGE_KEYS.sentenceBuilderProgress, STORAGE_KEYS.realLifeProgress, STORAGE_KEYS.learningOutcomes, 'klearn_ai_conversations'
]);
...
const CloudSyncService = {
  ...
  mergeVocabularyCollections(local = [], remote = []) {
    ...
    const mergeWords = (left = [], right = []) => {
      const map = new Map();
      [...(Array.isArray(left) ? left : []), ...(Array.isArray(right) ? right : [])].forEach((word) => {
        if (!word?.id) return; const previous = map.get(word.id); if (!previous) { map.set(word.id, word); return; }
        const merged = latest(previous, word); const tags = [...new Set([...(previous.tags || []), ...(word.tags || [])])]; const examples = mergeItems(previous.personalExamples, word.personalExamples);
        const notes = [...new Set([previous.personalNote, word.personalNote, ...(previous.noteConflicts || []), ...(word.noteConflicts || [])].filter(Boolean))];
        map.set(word.id, { ...merged, tags, personalExamples: examples, personalNote: merged.personalNote || notes[0] || '', noteConflicts: notes.filter((value) => value !== merged.personalNote).slice(0, 5) });
      });
      return [...map.values()];
    };
    const decks = new Map();
    [...(Array.isArray(local) ? local : []), ...(Array.isArray(remote) ? remote : [])].forEach((raw) => {
      ...
      const words = mergeWords(previous.customWords || previous.words, raw.customWords || raw.words);
      ...
      decks.set(raw.id, { ...merged, tags: [...new Set([...(previous.tags || []), ...(raw.tags || [])])], customWords: deletionWins ? [] : words, words: undefined, wordIds: deletionWins ? [] : merged.wordIds, topics, imports, sessionHistory, activity, activeSession: deletionWins ? null : activeSession });
    });
  ...
  mergeLanguageLearningState(local = {}, remote = {}) {
    local = local && typeof local === 'object' && !Array.isArray(local) ? local : {};
    remote = remote && typeof remote === 'object' && !Array.isArray(remote) ? remote : {};
    const languages = {}; const ids = new Set([...Object.keys(local.languages || {}), ...Object.keys(remote.languages || {})]);
  ...
  mergeMicroLearning(local = [], remote = []) {
    const left = Array.isArray(local) ? local[0] || {} : {}; const right = Array.isArray(remote) ? remote[0] || {} : {};
    const union = (a, b) => { const map = new Map(); const time = (item) => new Date(item?.updatedAt || item?.completedAt || item?.createdAt || 0).getTime() || 0; [...(Array.isArray(a) ? a : []), ...(Array.isArray(b) ? b : [])].forEach((item) => { const id = item?.id; if (!id) return; const previous = map.get(id); if (!previous || time(item) >= time(previous)) map.set(id, item); }); return [...map.values()].sort((aItem, bItem) => time(bItem) - time(aItem)); };
  ...
  mergeSocialEngagement(local = [], remote = []) {
    const left = Array.isArray(local) ? local[0] || {} : {}; const right = Array.isArray(remote) ? remote[0] || {} : {}; const time = (item) => new Date(item?.updatedAt || item?.createdAt || item?.claimedAt || 0).getTime() || 0;
    const union = (field, limit) => { const map = new Map(); [...(Array.isArray(left[field]) ? left[field] : []), ...(Array.isArray(right[field]) ? right[field] : [])].forEach((item) => { if (!item?.id) return; const previous = map.get(item.id); if (!previous || time(item) >= time(previous)) map.set(item.id, item); }); return [...map.values()].sort((a, b) => time(b) - time(a)).slice(0, limit); };
    const latest = new Date(right.updatedAt || 0) >= new Date(left.updatedAt || 0) ? right : left;
  ...
  mergeRealUserRetention(local = [], remote = []) {
    const left = Array.isArray(local) ? local[0] || {} : {}; const right = Array.isArray(remote) ? remote[0] || {} : {}; const stamp = (item) => new Date(item?.updatedAt || item?.completedAt || item?.unlockedAt || item?.date || item?.createdAt || 0).getTime() || 0;
  ...
  mergeVocabularyOrganization(local = [], remote = []) {
    const left = Array.isArray(local) ? local[0] || {} : {}; const right = Array.isArray(remote) ? remote[0] || {} : {};
    const stamp = (item = {}) => new Date(item.updatedAt || item.deletedAt || item.createdAt || 0).getTime() || 0; const mergeItems = (field, limit) => { const values = new Map(); [...(left[field] || []), ...(right[field] || [])].forEach((item) => { if (!item?.id) return; const previous = values.get(item.id); if (!previous || stamp(item) >= stamp(previous)) values.set(item.id, item); }); return [...values.values()].sort((a, b) => stamp(b) - stamp(a)).slice(0, limit); }; const folders = new Map();
    [...(left.folders || []), ...(right.folders || [])].forEach((folder) => { if (!folder?.id) return; const previous = folders.get(folder.id); if (!previous || stamp(folder) >= stamp(previous)) folders.set(folder.id, folder); });
    const latest = stamp(right) >= stamp(left) ? right : left;
    return [{ schemaVersion: 2, folders: [...folders.values()].slice(0, 1000), wordRelations: mergeItems('wordRelations', 5000), reviewHistory: mergeItems('reviewHistory', 100), updatedAt: latest.updatedAt || null }];
  },
  mergeDomain(key, local, remote) { if (key === STORAGE_KEYS.srs) return this.mergeSrs(local, remote); if (key === STORAGE_KEYS.vocabularyCollections) return this.mergeVocabularyCollections(local, remote); if (key === STORAGE_KEYS.vocabularyOrganization) return this.mergeVocabularyOrganization(local, remote); if (key === STORAGE_KEYS.progress) return this.mergeProgress(local, remote); if (key === STORAGE_KEYS.languageLearningState) return this.mergeLanguageLearningState(local, remote); if (key === STORAGE_KEYS.engagement) return this.mergeEngagement(local, remote); if (key === STORAGE_KEYS.microLearning) return this.mergeMicroLearning(local, remote); if (key === STORAGE_KEYS.immersiveSpoken) return this.mergeImmersiveSpoken(local, remote); if (key === STORAGE_KEYS.socialEngagement) return this.mergeSocialEngagement(local, remote); if (key === STORAGE_KEYS.learningEffectiveness) return this.mergeLearningEffectiveness(local, remote); if (key === STORAGE_KEYS.realUserRetention) return this.mergeRealUserRetention(local, remote); if (key === STORAGE_KEYS.productDelight) return this.mergeProductDelight(local, remote); return this.mergeValue(local, remote); },
...
const AITutorService = {
  ...
  addMessage(role, content, metadata = {}) { const conversation = this.ensure(); const ai = role === 'assistant' && metadata?.requestId ? { requestId: String(metadata.requestId).slice(0, 120), task: String(metadata.task || 'tutor').slice(0, 50), qualityScore: Math.max(0, Math.min(100, Number(metadata.quality?.score || 0))) } : undefined; conversation.messages.push({ role, content: String(content).slice(0, 4000), ...(ai ? { ai } : {}), createdAt: new Date().toISOString() }); conversation.messages = conversation.messages.slice(-30); conversation.updatedAt = new Date().toISOString(); conversation.title = conversation.messages.find((m) => m.role === 'user')?.content.slice(0, 42) || conversation.title; this.saveAll([conversation, ...this.all().filter((item) => item.id !== conversation.id)]); return conversation; },
  async send(content) {
    ...
    try {
      if (window.AIOrchestrationService?.request) { const result = await window.AIOrchestrationService.request({ task: 'tutor', input: text, messages: recentMessages, context: this.context(text), language: I18nService.getPreference() }); if (result?.reply) this.addMessage('assistant', result.reply, result); return result; }
...
function syncShell() {
  ...
  document.querySelectorAll('.nav-item').forEach((button) => {
    ...
    const activeView = ['daily-session', 'command-center', 'learning-progress'].includes(state.currentView) ? 'home'
      ...
      : ['ai-coach','adaptive-plan','error-notebook','ai-language-os'].includes(state.currentView) ? 'ai-coach'
      : ['profile','edit-profile','ux-settings','weekly-insights','progress-reports','personal-report','notes','bookmarks','real-goal-planner','learning-journal','teacher-review','teacher-workspace','community-hub','learning-community','study-groups','community-challenge','peer-practice','community-questions','community-profile','community-safety','language-exchange','community-moderation','education-platform','teacher-dashboard','organization-center','education-assignments','education-feedback','course-builder','organization-analytics','education-content','education-ecosystem','assessment-center','creator-workflow','school-report','education-certificates','enterprise-platform','subscription-center','premium-features','school-management','center-dashboard','course-marketplace','certification-center','partner-api','admin-analytics','language-platform','business-center','billing-center','organization-plans','revenue-center','crm-center','future-language-platform','cross-language-lab','language-brain','future-integrations','global-course-marketplace','global-language-platform','global-language-profiles','global-exam-framework','global-language-comparison','global-expansion','global-language-onboarding','global-writing-system','global-content-packs','global-language-search','global-adaptive-plan','retention-center','weekly-review','monthly-reflection','goal-milestones','retention-analytics','content-quality-dashboard','ai-content-studio','learning-outcomes','student-progress-report','teacher-outcomes','growth-center','invite-friends','growth-analytics','product-experiments','demo-center'].includes(state.currentView) ? 'profile'
...
function renderAiWidget() {
  ...
  window.AIHumanFeedbackService?.bind?.(root);
...
function lessonMiniTestQuestions(lesson = currentLessonContent()) {
  const words = lessonVocabulary(lesson);
  const dictionary = (window.KLEARN_DICTIONARY || []).filter((item) => item?.korean && I18nService.localizedText(item, 'meaning'));
  const pool = [...words, ...dictionary.filter((item) => !words.some((word) => word.id === item.id))];
  const wordAt = (index) => pool[index % Math.max(1, pool.length)] || { id: `fallback-${index}`, korean: ['학교', '학생', '공부하다'][index % 3], meanings: { vi: ['trường học', 'học sinh', 'học'][index % 3] } };
  const meaning = (word) => I18nService.localizedText(word, 'meaning') || word.meaningVi || word.meanings?.vi || '';
  const uniqueOptions = (correct, values) => [...new Set([correct, ...values].filter(Boolean))].slice(0, 4);
  const first = wordAt(0); const second = wordAt(1); const third = wordAt(2);
  const meanings = pool.slice(1, 12).map(meaning).filter(Boolean);
  const koreanWords = pool.slice(1, 12).map((item) => item.korean).filter(Boolean);
  const example = lesson.id === 'topic-particle' ? '저는 학생입니다.' : '한국어를 꾸준히 연습해요.';
  return [
    { id: 'meaning', prompt: `${first.korean} có nghĩa là gì?`, options: uniqueOptions(meaning(first), meanings), correctAnswer: meaning(first), explanation: `${first.korean} nghĩa là “${meaning(first)}”. Đây là từ trọng tâm của bài.`, wordId: first.id },
    { id: 'korean', prompt: `Chọn từ tiếng Hàn có nghĩa “${meaning(second)}”.`, options: uniqueOptions(second.korean, koreanWords), correctAnswer: second.korean, explanation: `“${meaning(second)}” trong tiếng Hàn là ${second.korean}.`, wordId: second.id },
    { id: 'location', prompt: '저는 학교__ 가요. Chọn trợ từ đúng.', options: ['에', '를', '는'], correctAnswer: '에', explanation: '에 đánh dấu địa điểm đến: 학교에 가요 = đi đến trường.' },
    { id: 'past', prompt: '어제 친구를 ___. Chọn dạng phù hợp.', options: ['만났어요', '만나요', '갈 거예요'], correctAnswer: '만났어요', explanation: '어제 là “hôm qua”, vì vậy động từ cần ở thì quá khứ: 만났어요.' },
    { id: 'listening', prompt: 'Nghe câu rồi chọn nghĩa gần nhất.', audioText: example, options: lesson.id === 'topic-particle' ? ['Tôi là học sinh.', 'Tôi đi đến trường.', 'Tôi học tiếng Hàn.'] : ['Tôi luyện tiếng Hàn đều đặn.', 'Tôi là giáo viên tiếng Hàn.', 'Hôm nay tôi không học.'], correctAnswer: lesson.id === 'topic-particle' ? 'Tôi là học sinh.' : 'Tôi luyện tiếng Hàn đều đặn.', explanation: lesson.id === 'topic-particle' ? '저는 학생입니다 nghĩa là “Tôi là học sinh”.' : '꾸준히 mang nghĩa đều đặn, kiên trì.', wordId: third.id }
  ];
}

function lessonMiniTestMarkup(lesson) {
  const questions = lessonMiniTestQuestions(lesson); const answers = state.lessonMiniAnswers || {}; const result = state.lessonMiniResult?.lessonId === lesson.id ? state.lessonMiniResult : null;
  return `<section class="lesson-step-card card lesson-mini-test"><p class="eyebrow">Mini test · 5 câu</p><h2 class="section-title">Kiểm tra trước khi hoàn thành</h2><p class="subtle">Trả lời đủ 5 câu. Sau khi nộp, bạn luôn thấy đáp án và lý do.</p>${questions.map((question, index) => { const selected = answers[question.id]; const correct = selected === question.correctAnswer; return `<article class="lesson-mini-question ${result ? (correct ? 'correct' : 'wrong') : ''}"><div class="lesson-mini-heading"><span>${index + 1}</span><b>${escapeHtml(question.prompt)}</b>${question.audioText ? `<div class="lesson-audio-pair"><button type="button" data-speak-rate="1" data-speak-text="${escapeHtml(question.audioText)}">🔊 Bình thường</button><button type="button" data-speak-rate="0.7" data-speak-text="${escapeHtml(question.audioText)}">🐢 Chậm</button></div>` : ''}</div><div class="lesson-choice-grid">${question.options.map((option) => `<button type="button" class="lesson-choice ${selected === option ? 'selected' : ''}" data-lesson-mini-question="${question.id}" data-answer="${escapeHtml(option)}" ${result ? 'disabled' : ''}>${escapeHtml(option)}</button>`).join('')}</div>${result ? `<div class="lesson-mini-explanation ${correct ? 'success' : 'error'}"><b>${correct ? '✓ Đúng' : `✕ Đáp án đúng: ${escapeHtml(question.correctAnswer)}`}</b><p>${escapeHtml(question.explanation)}</p></div>` : ''}</article>`; }).join('')}${result ? `<div class="lesson-mini-score"><strong>${result.score}/100</strong><div><b>${result.passed ? 'Đã sẵn sàng học tiếp' : 'Nên ôn lại trước bài mới'}</b><p>${result.correct}/5 câu đúng. ${result.passed ? 'Bài tiếp theo sẽ được mở khi bạn lưu hoàn thành.' : 'Bạn vẫn có thể lưu bài; hệ thống giữ khuyến nghị ôn lại trong tiến độ.'}</p></div></div>` : `<button class="btn primary full" id="submitLessonMiniTest" ${Object.keys(answers).length < questions.length ? 'disabled' : ''}>Nộp mini test</button>`}</section>`;
}

function lessonView() {
  const lesson = currentLessonContent();
  const completed = Boolean(state.lessonProgress[lesson.id]?.completed); const step = Math.max(0, Math.min(7, Number(state.lessonStep) || 0)); const romanization = showRomanizationEnabled();
  ...
  const stepTitles = ['Mục tiêu', 'Từ vựng', 'Giải thích', 'Ví dụ', 'Quick Check', 'Practice', 'Mini test', 'Tổng kết'];
  const body = [
    ...
    lessonMiniTestMarkup(lesson),
    `<section class="lesson-step-card card lesson-summary"><div class="celebration">✓</div><p class="eyebrow">Hoàn thành bài</p><h2 class="headline">Bạn đã đi hết ${stepTitles.length} bước</h2><p class="subtle">Tiến độ, mini test và mastery sẽ được lưu vào đúng bài học ${escapeHtml(lesson.title || '')}.</p><div class="result-counts"><span>Thời lượng <b>${lesson.estimatedMinutes || 10}′</b></span><span>Mini test <b>${state.lessonMiniResult?.score ?? state.lessonProgress[lesson.id]?.miniTestScore ?? '—'}%</b></span><span>Trạng thái <b>${completed ? 'Đã hoàn thành' : 'Sẵn sàng lưu'}</b></span></div></section>`
  ][step];
  const miniReady = completed || Boolean(state.lessonMiniResult?.completed && state.lessonMiniResult?.lessonId === lesson.id);
  return `<div class="lesson-header"><button class="close-btn" data-view="lessons" aria-label="${I18nService.t('lesson.close')}">×</button><div class="lesson-progress"><div class="bar"><span style="width:${Math.round(((step + 1) / stepTitles.length) * 100)}%"></span></div></div><span class="subtle">${step + 1} / ${stepTitles.length}</span></div><section class="section lesson-title"><p class="eyebrow">${escapeHtml(lesson.title || 'Bài học')}</p><h1 class="headline">${stepTitles[step]}</h1><p class="subtle">${escapeHtml(lesson.topic || '')}</p></section><div class="lesson-stepper">${stepTitles.map((title, index) => `<span class="${index === step ? 'active' : index < step ? 'done' : ''}">${index + 1}. ${title}</span>`).join('')}</div>${body}<div class="action-row lesson-actions"><button class="btn secondary" data-lesson-prev ${step === 0 ? 'disabled' : ''}>← Quay lại</button>${step < stepTitles.length - 1 ? `<button class="btn primary" data-lesson-next ${step === 6 && !miniReady ? 'disabled' : ''}>Tiếp theo →</button>` : `<button class="btn primary" id="completeLesson" ${!completed && !miniReady ? 'disabled' : ''}>${completed ? 'Đã hoàn thành ✓' : 'Lưu tiến độ'}</button>`}</div>`;
}
...
function bindEvents() {
  ...
  document.querySelectorAll('[data-lesson-next]').forEach((button) => { button.onclick = () => { state.lessonStep = Math.min(7, (Number(state.lessonStep) || 0) + 1); render(); }; });
  ...
  document.querySelectorAll('[data-lesson-mini-question]').forEach((button) => { button.onclick = () => { if (state.lessonMiniResult) return; state.lessonMiniAnswers = { ...(state.lessonMiniAnswers || {}), [button.dataset.lessonMiniQuestion]: button.dataset.answer }; render(); }; });
  const submitLessonMiniTest = document.getElementById('submitLessonMiniTest'); if (submitLessonMiniTest) submitLessonMiniTest.onclick = () => { const lesson = currentLessonContent(); const questions = lessonMiniTestQuestions(lesson); const answers = state.lessonMiniAnswers || {}; if (questions.some((question) => !Object.prototype.hasOwnProperty.call(answers, question.id))) return toast('Hãy trả lời đủ 5 câu.'); const correct = questions.filter((question) => answers[question.id] === question.correctAnswer).length; const score = correct * 20; state.lessonMiniResult = { lessonId: lesson.id, correct, total: questions.length, score, passed: score >= 60, completed: true, completedAt: new Date().toISOString() }; questions.filter((question) => answers[question.id] !== question.correctAnswer).forEach((question) => window.ErrorNotebookService?.add?.({ type: question.id === 'meaning' || question.id === 'korean' ? 'vocabulary' : question.id === 'listening' ? 'listening' : 'grammar', wordId: question.wordId || '', question: question.prompt, mistake: answers[question.id], correction: question.correctAnswer, explanation: question.explanation, source: 'lesson-mini-test', lessonId: lesson.id })); render(); };
...
function openLesson(lessonId) {
  ...
  window.UserResearchService?.track?.('lesson_started', { contentId: lessonId, feature: 'lesson' });
  state.lessonStep = 0;
  state.lessonCheck = null;
  state.lessonMiniAnswers = {};
  state.lessonMiniResult = null;
  state.selectedWords = [];
...
function completeLesson() {
  ...
  const miniResult = state.lessonMiniResult?.lessonId === lessonId ? state.lessonMiniResult : null;
  if (!miniResult?.completed && !state.lessonProgress[lessonId]?.completed) return;
  const progress = getUserProgress();
  ...
  if (firstCompletion) {
    ...
    const lesson = currentLessonContent(); const miniScore = Number(miniResult?.score || 0); const masteryScore = Math.max(Number(existing.masteryScore) || 0, Math.round(55 + miniScore * .35));
    progress.lessonProgress[lessonId] = { ...existing, completed: true, completedAt, score: miniScore, miniTestScore: miniScore, miniTestCorrect: Number(miniResult?.correct || 0), miniTestTotal: Number(miniResult?.total || 5), recommendedReview: miniScore < 60, studyMinutes: Number(lesson.estimatedMinutes || 10), masteryScore, masteryStatus: MasteryService.status(masteryScore), recallCount: Number(existing.recallCount || 0) + 1, contentVersion: 2, updatedAt: completedAt };
...
function rateSrs(rating) {
  ...
  window.UserResearchService?.track?.('review_completed', { feature: 'srs', result: rating === 'forgot' ? 'forgot' : 'remembered' });
  saveUserProgress(progress);
  session.index += 1;
  session.completed += 1;
  state.flashcardFlipped = false;
...
if (restoredUser) {
  ...
  if (restoredUser.isDemo === true) window.KLEARN_ROUTE_LOADER?.loadGroup?.('demo')?.then(() => render()).catch(() => {});
