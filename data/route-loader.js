...
(() => {
  ...
  const groups = Object.freeze({
    ...
    ai: { scripts: ['data/ai-coach.js?v=9', 'data/learning-memory.js?v=3', 'data/personal-intelligence.js?v=3', 'data/learning-intelligence-data.js?v=1', 'data/learning-intelligence.js?v=2'] },
  ...
  routes('my-vocabulary-p82 vocabulary-deck-p82 vocabulary-import-p82 vocabulary-classify-p82 vocabulary-session-p82 vocabulary-today-p84 vocabulary-organize-p84 vocabulary-session-setup-p84 vocabulary-mastery-p84 vocabulary-mastery-session-p84 vocabulary-intelligence-p84 vocabulary-report-p84 vocabulary-recovery-p84', ['p84VocabularyDaily']);
