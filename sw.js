...
const OFFLINE_ASSETS = [
  ...
  './data/cloud-sync.js?v=3',
  './data/ai-coach.js?v=5',
  ...
  './data/production-stability.js?v=2',
  ...
  './data/career-learning-ecosystem.js?v=1',
