...
const OFFLINE_ASSETS = [
  ...
  './data/adaptive-engine.js?v=4',
  './data/personal-intelligence.js?v=1',
  './data/practical-study.js?v=2',
  './data/beginner-foundation.js?v=1',
  './data/ecosystem-scale.js?v=7',
  ...
  './data/learning-intelligence.js?v=1',
