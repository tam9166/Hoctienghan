...
const OFFLINE_ASSETS = [
  ...
  './beginner-learning-assistant.css?v=2',
  './p78-mobile-native.css?v=2',
  './vocabulary-immersion-system.css?v=2',
  './personal-vocabulary-system.css?v=1',
  './smart-document-vocabulary-import.css?v=1',
  './vocabulary-daily-action.css?v=1',
  './personal-vocabulary-organization.css?v=1',
  './vocabulary-mastery-real-usage.css?v=1',
  './personal-learning-intelligence.css?v=1',
  './topik-exam-intelligence-system.css?v=3',
  ...
  './premium-monetization-platform.css?v=1',
  ...
  './data/daily-learning-experience.js?v=7',
  './data/personal-vocabulary-organization.js?v=1',
  './data/vocabulary-mastery-real-usage.js?v=1',
  './data/personal-learning-intelligence.js?v=1',
  './data/language-mastery.js?v=1',
  './data/immersion-motivation.js?v=1',
  './data/education-platform.js?v=2',
  './data/education-ecosystem-platform.js?v=1',
  './content/education-ecosystem-platform.json',
  ...
  './data/beginner-learning-assistant.js?v=3',
  ...
  './data/route-loader.js?v=32',
  './app.js?v=89',
  './data/engagement-core.js?v=2',
  './content/engagement-core.json',
  './data/micro-learning-experience.js?v=1',
  './content/micro-learning-experience.json',
  './data/immersive-spoken-content.js?v=1',
  './content/immersive-spoken-content.json',
  './data/social-engagement.js?v=1',
  ...
  './data/real-user-retention.js?v=4',
  './content/real-user-retention.json',
  './data/product-delight.js?v=1',
  ...
  './data/premium-monetization-platform.js?v=1',
  './content/premium-monetization-platform.json',
  ...
  './data/vocabulary-immersion-system.js?v=3',
  ...
  './data/vocabulary-daily-action.js?v=1',
  './data/topik-exam-intelligence-system.js?v=3',
  './content/topik-exam-intelligence-system.json?v=2',
  './topik-strategy-coaching-system.css?v=1',
  './data/topik-strategy-coaching-system.js?v=1',
  './content/topik-strategy-coaching-system.json',
  ...
  './data/premium-monetization-architecture.js?v=1',
  './content/premium-monetization-architecture.json',
...
const INSTALL_ASSETS = new Set([
  './index.html', './styles.css?v=33', './product-ux.css?v=2', './beginner-learning-assistant.css?v=2', './production-stability.css?v=2', './security-privacy.css?v=1', './mobile-experience.css?v=1',
  ...
  './mobile-runtime-config.js?v=1', './data/platform-runtime.js?v=1', './data/cloud-sync.js?v=5', './data/learning-modules.js?v=9', './data/practice-bank.js?v=8', './data/route-loader.js?v=32', './app.js?v=89',
  './data/curriculum.js?v=1', './data/adaptive-engine.js?v=9', './data/beginner-foundation.js?v=2', './data/daily-learning-experience.js?v=7',
  './data/product-ux.js?v=2', './data/beginner-learning-assistant.js?v=3', './content/product-ux.json', './data/user-research.js?v=2', './content/user-research-experiments.json',
  ...
  './vocabulary-immersion-system.css?v=2', './data/vocabulary-immersion-system.js?v=3', './content/vocabulary-immersion-system.json',
