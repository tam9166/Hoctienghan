...
(async () => {
  ...
  assert.match(index, /ai-agent-architecture\.css\?v=1/); assert.match(index, /data\/ai-agent-architecture\.js\?v=1/); assert.match(index, /app\.js\?v=53/);
  assert.match(worker, /klearn-v67/); assert.match(worker, /content\/ai-agent-architecture\.json/); assert.match(appSource, /aiAgents: 'klearn_ai_agents'/); assert.match(appSource, /STORAGE_KEYS\.aiAgents/);
