...
(async () => {
  ...
  assert.match(index, /ai-language-os\.css\?v=1/); assert.match(index, /data\/ai-language-operating-system\.js\?v=1/); assert.match(index, /data\/route-loader\.js\?v=14/); assert.match(index, /app\.js\?v=74/);
  assert.match(worker, /klearn-v88/); assert.match(worker, /content\/ai-language-operating-system\.json/); assert.match(css, /@media \(max-width: 620px\)/);
