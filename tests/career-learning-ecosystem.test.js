...
(async () => {
  ...
  assert.match(index, /career-learning\.css\?v=1/); assert.match(index, /data\/career-learning-ecosystem\.js\?v=1/); assert.match(index, /app\.js\?v=51/); assert.match(worker, /klearn-v65/); assert.match(worker, /content\/career-learning-ecosystem\.json/); assert.match(appSource, /careerLearning: 'klearn_career_learning'/); assert.match(appSource, /STORAGE_KEYS\.careerLearning/); assert.match(css, /@media\(max-width:600px\)/);
