...
(async () => {
  ...
  assert.match(index, /global-education-marketplace\.css\?v=1/); assert.match(index, /data\/global-education-marketplace\.js\?v=1/); assert.match(index, /app\.js\?v=83/);
  assert.match(worker, /klearn-v101/); assert.match(worker, /content\/global-education-marketplace\.json/); assert.match(appSource, /globalEducationMarketplace: 'klearn_global_education_marketplace'/); assert.match(appSource, /STORAGE_KEYS\.globalEducationMarketplace/);
