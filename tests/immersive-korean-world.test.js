...
assert.match(index, /immersive-korean-world\.css\?v=1/); assert.match(index, /data\/immersive-korean-world\.js\?v=1/); assert.match(index, /app\.js\?v=60/); assert.match(worker, /klearn-v74/); assert.match(worker, /content\/immersive-korean-world\.json/); assert.match(appSource, /immersiveKoreanWorld: 'klearn_immersive_korean_world'/); assert.match(appSource, /STORAGE_KEYS\.immersiveKoreanWorld/);
