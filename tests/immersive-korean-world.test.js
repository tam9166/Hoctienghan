...
assert.match(index, /immersive-korean-world\.css\?v=2/); assert.match(index, /data\/immersive-korean-world\.js\?v=2/); assert.match(index, /app\.js\?v=75/); assert.match(worker, /klearn-v89/); assert.match(worker, /content\/immersive-korean-world\.json/); assert.match(appSource, /immersiveKoreanWorld: 'klearn_immersive_korean_world'/); assert.match(appSource, /STORAGE_KEYS\.immersiveKoreanWorld/);
