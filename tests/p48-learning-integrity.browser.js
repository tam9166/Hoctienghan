...
(async () => {
  ...
  try {
    ...
    const result = await evaluate(cdp, `(async () => {
      ...
      app.updateCurrentUser({onboardingCompleted:true,onboardingStep:'completed',learningTrack:'foundation',foundationEntry:'hangul-academy'}); app.setView('home'); const beginnerHome={view:app.state.currentView,text:document.getElementById('app').innerText};
