...
(async () => {
  ...
  try {
    ...
    assert.deepEqual(result.merge, { mastery: 90, reviewCount: 8, nextReview: '2026-08-10T00:00:00.000Z', deterministic: true, masteredDue: true });
