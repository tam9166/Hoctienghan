...
(async () => {
  ...
  assert.match(worker, /klearn-v103/); assert.match(worker, /content\/real-korean-experience\.json/); assert.match(css, /@media\(max-width:700px\)/); assert.match(css, /@media\(max-width:380px\)/);
