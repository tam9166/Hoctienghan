...
(async () => {
  ...
  assert.match(worker, /klearn-v94/); assert.match(worker, /content\/content-science-system\.json/); assert.match(css, /@media\(max-width:600px\)/); assert.match(css, /@media\(max-width:380px\)/);
