...
(async () => {
  ...
  assert.match(index, /engagement-core\.css\?v=1/); assert.match(index, /data\/engagement-core\.js\?v=1/); assert.match(worker, /klearn-v91/); assert.match(worker, /content\/engagement-core\.json/); assert.match(css, /@media \(max-width: 600px\)/);
