...
(() => {
  ...
  assert.match(index, /micro-learning-experience\.css\?v=1/); assert.match(index, /data\/micro-learning-experience\.js\?v=1/); assert.match(index, /app\.js\?v=86/);
  assert.match(worker, /klearn-v104/); assert.match(worker, /content\/micro-learning-experience\.json/); assert.match(css, /@media \(max-width: 600px\)/); assert.match(css, /prefers-reduced-motion/);
