...
assert.doesNotMatch(index, /data\/learning-effectiveness\.js\?v=1/); assert.match(index, /app\.js\?v=85/);
assert.match(worker, /klearn-v103/); assert.match(worker, /content\/learning-effectiveness\.json/); assert.match(worker, /learning-effectiveness\.css\?v=1/);
