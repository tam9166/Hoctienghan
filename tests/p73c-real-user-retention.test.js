...
assert.doesNotMatch(index, /data\/real-user-retention\.js\?v=4/); assert.match(index, /app\.js\?v=86/); assert.match(index, /route-loader\.js\?v=30/);
...
assert.match(worker, /klearn-v104/); assert.match(worker, /content\/real-user-retention\.json/); assert.match(worker, /real-user-retention\.css\?v=2/);
