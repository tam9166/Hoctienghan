...
assert.doesNotMatch(index, /data\/real-user-retention\.js\?v=4/); assert.match(index, /app\.js\?v=83/); assert.match(index, /route-loader\.js\?v=25/);
...
assert.match(worker, /klearn-v101/); assert.match(worker, /content\/real-user-retention\.json/); assert.match(worker, /real-user-retention\.css\?v=2/);
