...
assert.doesNotMatch(index, /data\/real-user-retention\.js\?v=4/); assert.match(index, /app\.js\?v=81/); assert.match(index, /route-loader\.js\?v=23/);
assert.match(loader, /realUserRetentionCore/); assert.match(loader, /routes\('home', \['growth', 'realUserRetentionCore'\]\)/);
assert.match(worker, /klearn-v99/); assert.match(worker, /content\/real-user-retention\.json/); assert.match(worker, /real-user-retention\.css\?v=2/);
