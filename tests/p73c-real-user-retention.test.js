...
assert.doesNotMatch(index, /data\/real-user-retention\.js\?v=4/); assert.match(index, /app\.js\?v=82/); assert.match(index, /route-loader\.js\?v=24/);
...
assert.match(worker, /klearn-v100/); assert.match(worker, /content\/real-user-retention\.json/); assert.match(worker, /real-user-retention\.css\?v=2/);
